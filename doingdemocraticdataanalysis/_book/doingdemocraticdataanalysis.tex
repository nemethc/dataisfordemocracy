...
\hypertarget{what-is-this-guide-not}{%
\section*{What is this guide not?}\label{what-is-this-guide-not}}
\addcontentsline{toc}{section}{What is this guide not?}

This is not an excel how-to manual. My hope is that the principles and practices outlined here will allow you to explore whatever analysis tools you are interested in in a democratic manner. With that said, practical examples are given in Excel and in R. You can download the accompanying workbook \href{www.google.com}{here}.
...
Data analysis is the process of transforming numbers on a page to insight into the real world. It's looking at a table and gaining insight from it. Data analysis can be as simple as adding totals into a column to see cumulative effects, or as complicated as time-series forecasting. But fundementally, all data analysis is taking inputs and applying those inputs to the real world to gain insight into the real world. It also may be helpful to think about what data analysis \emph{isn't}:
...
\hypertarget{a-quick-note-on-tools}{%
\section{A Quick Note on Tools}\label{a-quick-note-on-tools}}

As I mentioned in the intro, examples in this guide will be given in R and Excel. Most of the Excel examples will use a tool called Get \& Transform Data (formerly known as PowerQuery). If you are a Mac user, it is likely that you will not have access to this tool (which is a shame). My first encouragement would be to give \texttt{r} a try. However, you can also download the desktop version of Microsoft PowerBI for free. It uses the same set of data tools as Get \& Transform in Excel, and the ability to make nice interactive charts (because everything in data analysis is a pivot table-- but more on that later.)
...
\hypertarget{htmlwidget-655fdbc8f06d77323408}{}
...
Pivot tables are the world's most common, most helpful, and most underrated data analysis tool. If you understand the mechanics of the pivot table, you have everything you need to be a data analysis expert. PowerBI interactive charts and graphs are just pivot tables in disguise. Understanding what is needed to make a pivot table work is the key to the wide world of data analysis.
...
\hypertarget{htmlwidget-4a1aac9c0bcbc76a1b52}{}
...
\hypertarget{htmlwidget-4393f45be24d3027e427}{}
...
\hypertarget{htmlwidget-36387e3860d83e21ca3c}{}
