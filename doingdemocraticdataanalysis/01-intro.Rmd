...
If you have typed a formula in excel, congrats! You are a programmer. Embrace it! Excel is the world's largest and most underrated programming language. Now, you just have to think like a programmer. It's like grammar. There are rules so these sentances (hopefully) make sense to you, the reader. Similarily, by following common conventions of data analysis, others will be able to "read" your analysis like you are reading this sentance. And also, like grammar, you can break the rules-- but it helps to know them first. 
